            ...
            return new Schema<>()
                    ...
                    .maxProperties(
                            main.getMaxProperties() == null && patch.getMaxProperties() != null
                                    ? patch.getMaxProperties()
                                    : main.getMaxProperties())
                    .minProperties(
                    ...
                    .exampleSetFlag(main.getExampleSetFlag() || patch.getExampleSetFlag());
        }
    }
    ...
    public static Schema<?> mergeWithOverride(Schema<?> main, Schema<?> patch) {
        if (main == null) {
            ...
            return new Schema<>()
                    ...
                    .maxProperties(
                            patch.getMaxProperties() != null ? patch.getMaxProperties() : main.getMaxProperties())
                    .minProperties(
