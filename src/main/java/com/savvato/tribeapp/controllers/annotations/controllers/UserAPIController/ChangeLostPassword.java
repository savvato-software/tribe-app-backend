...
@Documented
@Operation(
    summary = "Change lost password",
    description = "Provided a valid ChangePasswordRequest (see schema), change lost password.")
@DocumentedRequestBody(
    description = "The lost password change request",
    implementation = ChangePasswordRequest.class)
@Success(description = "Successfully changed password", implementation = User.class)
@BadGateway
public @interface ChangeLostPassword {}
