...
public class ToBeReviewedCheckerServiceImplTest {
    ...
    public void checkPartOfSpeech() {
        ...
        boolean rtn = toBeReviewedCheckerService.checkPartOfSpeech(word, expectedPartOfSpeech, wordDetails);
    ...
    public void validatePhraseComponentWhenComponentIsValidNoun() {
        ...
        doReturn(true).when(toBeReviewedCheckerServiceSpy).checkPartOfSpeech(word, expectedPartOfSpeech, wordDetails);
    ...
    public void validatePhraseComponentWhenComponentIsIncorrectPartOfSpeech() {
        ...
        ToBeReviewedCheckerService toBeReviewedCheckerServiceSpy = spy(toBeReviewedCheckerService);
        doReturn(wordDetails).when(toBeReviewedCheckerServiceSpy).getWordDetails(word);
        doReturn(false).when(toBeReviewedCheckerServiceSpy).checkPartOfSpeech(word, expectedPartOfSpeech, wordDetails);
